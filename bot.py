...
async def start(event):
  await event.reply(
    "__**I'm MentionAll Bot**, I will help you to mention near about all members in your group and channel 👻\nClick **/help** for more information__\n\n Follow [@FerdiSupport](https://t.me/Galerifsyrl) on Github",
    link_preview=False,
    buttons=(
      [
        Button.url('📣 Channel', 'https://t.me/BestieVirtual'),
        Button.url('📦 Store', 'https://t.me/Galerifsyrl')
      ]
    )
  )
...
async def help(event):
  ...
  await event.reply(
    ...
    buttons=(
      [
        Button.url('📣 Channel', 'https://t.me/Nenen_degrees'),
        Button.url('Store', 'https://t.me/Galerifsyrl')
      ]
    )
  )
